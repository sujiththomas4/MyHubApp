...
export const menu = [
  ...
  { id: 'challenge-10', label: '22 Clean Trades', icon: 'ri-focus-3-line', to: '/trading-challenge/10-clean' },
...

  {
    ...
    children: [
      ...
      { id: 'ee-ema', label: '50 & 200 EMA Support', to: '/wealth/eva-ezaak/ema-support' },
  ...
  { id: 'business-swing-weekly', label: 'Swing Weekly', icon: 'ri-calendar-week-line', to: '/business/swing-weekly', badge: { text: 'W', variant: 'info' } },
...

  {
    ...
    children: [
      ...
      { id: 'plantation-inventory', label: 'Inventory', to: '/business/plantations/inventory' },
